    ...
    <>
      <div className="flex flex-col py-12 md:flex-row items-center justify-between">
        ...
        <div className="w-full items-center flex flex-col justify-center px-2 sm:w-1/3 gap-2">
          ...
          <p>
            Welcome to Meta Blog, a creative digital space where ideas meet innovation. We are passionate about crafting engaging content and building secure, user-friendly platforms that inspire and connect people. Our mission is to deliver meaningful experiences through technology, creativity, and storytelling.
          </p>
